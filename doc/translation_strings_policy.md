...
This document provides guidelines for internationalization of the SolD Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `sold_en.ts` remains unchanged.
