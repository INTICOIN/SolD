...
This mechanism has been integrated into Bitcore-Node-SolD which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/soldpay/insight-api-sold#web-socket-api](https://github.com/soldpay/insight-api-sold#web-socket-api)
* API: [https://github.com/soldpay/insight-api-sold#instantsend-transactions](https://github.com/soldpay/insight-api-sold#instantsend-transactions)
