    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  sold-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the SolD in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 SOLd, 0.01 SOLd, 0.1 SOLd, 1 SOLd and 10 SOLd -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%1\" href=\"https://docs.sold.org/en/stable/wallets/soldcore/privatesend-instantsend.html\">PrivateSend documentation</a>."
