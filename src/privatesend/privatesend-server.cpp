...
/*
    ...
    allow endless transaction that would bloat SolD and make it unusable. To
...
bool CPrivateSendServer::IsInputScriptSigValid(const CTxIn& txin)
{
    ...
    if (nTxInIndex >= 0) { //might have to do this one input at a time?
        ...
        // TODO we're using amount=0 here but we should use the correct amount. This works because SolD ignores the amount while signing/verifying (only used in Bitcoin/Segwit)
