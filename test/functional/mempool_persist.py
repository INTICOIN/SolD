...
By default, soldd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(1)
        self.start_node(2)
        # Give soldd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent soldd from writing mempool.dat to disk. Verify that `savemempool` fails")
