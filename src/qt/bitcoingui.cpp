...
// Copyright (c) 2014-2019 The SolD Core developers
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SolD address"));
    ...
    privateSendCoinsAction->setStatusTip(tr("PrivateSend coins to a SolD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sold: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about SolD Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SolD addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SolD addresses"));
    ...
    openAction->setStatusTip(tr("Open a sold: URI or payment request"));

    showHelpMessageAction = new QAction(tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible SolD command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SolD network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the sold logo
...
{
    QString strTitle = tr("SolD Core"); // default title
