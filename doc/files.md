...
* sold.conf: contains configuration settings for soldd or sold-qt
* soldd.pid: stores the process id of soldd while running
...
* debug.log: contains debug information and general logging generated by soldd or sold-qt
