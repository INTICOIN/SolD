...
/* SolDGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* SolDGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "SolD"
#define QAPP_ORG_DOMAIN "sold.org"
#define QAPP_APP_NAME_DEFAULT "SolD-Qt"
#define QAPP_APP_NAME_TESTNET "SolD-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "SolD-Qt-%s"
#define QAPP_APP_NAME_REGTEST "SolD-Qt-regtest"
