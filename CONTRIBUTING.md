Contributing to SolD Core
============================

The SolD Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/soldpay/sold/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the SolD Core project (and related
projects such as libsecp256k1), and is not to be confused with overall SolD
Network Protocol consensus changes.

Whether a pull request is merged into SolD Core rests with the project merge
...
Patches that change SolD consensus rules are considerably more involved than
...
Where a patch set proposes to change the SolD consensus, it must have been
...
The review process is normally fairly responsive on the SolD Core repository, however
...
The project leader is the release manager for each SolD Core release.
