...
"""Verify that starting soldd with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start soldd with -h for help text")
        ...
        self.log.info("Start soldd with -version for version information")
