// Copyright (c) 2018-2019 The SolD Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SOLd_CRYPTO_BLS_BATCHVERIFIER_H
#define SOLd_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //SOLd_CRYPTO_BLS_BATCHVERIFIER_H
