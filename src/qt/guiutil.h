...
/** Utility functions used by the SolD Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "sold:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load sold specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a sold specific theme is activated (light/dark).*/
