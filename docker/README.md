...
official/supported Docker Images found at https://hub.docker.com/r/soldpay/soldd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/soldpay/soldd-develop/ when changing the above text**